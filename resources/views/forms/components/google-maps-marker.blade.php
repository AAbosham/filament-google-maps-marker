<script src="https://maps.googleapis.com/maps/api/js?key={{config('filament-google-maps-marker.google_maps_key')}}&libraries=places&v=weekly&language={{app()->getLocale()}}"></script>
